    ...
    <div class="">
        <section
            ...
            <div class="px-4 mx-auto max-w-screen-xl text-center py-24 lg:py-56">
                <h1 class="mb-4 text-4xl font-extrabold tracking-tight leading-none text-white md:text-5xl lg:text-6xl">Lorem
                ...
                <p class="mb-8 text-lg font-normal text-gray-300 lg:text-xl sm:px-16 lg:px-48">Lorem ipsum dolor sit amet
                    consectetur adipisicing elit. Velit exercitationem itaque nesciunt minima, soluta earum architectoHere
                    at Flowbite we focus on
                    markets where technology, innovation, and capital can unlock long-term value and drive economic growth
                    perferendis nisi suscipit cumque inventore numquam ex, repellat error nulla corporis perspiciatis libero
                    quaerat molestias vel. Dolorem nemo molestiae in animi enim labore quasi..
                </p>
