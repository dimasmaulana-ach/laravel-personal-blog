...
@section('dashboard')
    <div class="">
        <div class="flex">
            <h1 class="font-bold text-5xl dark:text-white">Edit Blogs</h1>
        </div>
        <div class="mt-5 w-full ">
            <form action="/dashboard/blogs/{{ $blogs->slug }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="gap-8 sm:grid sm:grid-cols-2 my-4">
                    <div class="">
                        ...
                        <div class="mb-6">
                            ...
                            <select id="category" name="category_id"
                                ...
                                @foreach ($category as $item)
                                    @if (old('category_id', $blogs->category->id) == $item->id)
                        ...
                        <div class="mb-6">
                            ...
                            @if ($blogs->image)
                                <img src="{{ asset('storage/'.$blogs->image) }}" class="h-auto max-w-xs image-preview" alt="">
                            @else
                                <img class="h-auto max-w-xs image-preview" alt="">
                            @endif
                        </div>
                    </div>
                    <div class="">
